...
public class CommonAction {
    ...
    public void printThread(InvInvInfo invInvInfo) {
        try {
            ...
            tradeDataInfoElem = root.addElement("TradeData");
            if (!"".equals(curRemark)) {
                invInvInfo.setInvRemark(invInvInfo.getPriceSum().divide(curRat) + curRemark);
                tradeDataInfoElem.addAttribute("name", "BUS_REMARK").addAttribute("data", invInvInfo.getPriceSum().divide(curRat) + curRemark);
            } else {
